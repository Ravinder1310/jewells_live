...
const CartPage = () => {
  ...
  const userName = auth?.token ? auth?.user?.name : "User";
  ...
  return (
    ...
    <img src="`https://readme-typing-svg.demolab.com/?lines= a ;Curious%20to%20learn%20new%20things !&font=Fira%20Code&center=true&width=440&height=45&color=#57bcf7&vCenter=true&size=22&pause=1000`"/></a> */}
        </div>
        <div className="row">
          {cart?.length > 0 ? 
    ...
    <div className="mt-2">
      ...
      : <div className="emptyImage">  <img src="/images/emptyCart4.png" width={'400px'} height={'300px'} alt="Image not found"/><br/>
